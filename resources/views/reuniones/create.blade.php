            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                <div class="p-8">
                    ...
                    <div class="mb-8">
                        ...
                        <p class="text-gray-600">Complete todos los campos requeridos para crear su reunión</p>
                    </div>

                    <!-- Form -->
                    <form action="{{ route('dashboard.reuniones.store') }}" method="POST" id="reunionForm" novalidate>
                        @include('reuniones._form_wizard', ['submitButtonText' => 'Crear Reunión'])
                    </form>
                </div>
            </div>
        </div>
